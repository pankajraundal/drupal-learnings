...
class TranslationMemoryApi
{
    ...
    public function handleThrottling($request, $options){
        ...
        while(!$validResponse){
            ...
            if(($response->getStatusCode() != 429 && $response->getStatusCode() < 500) || $attempts >= 9){
                $validResponse = true;
            }else{
                $attempts = $attempts + 1;
                sleep(3);
    ...
    {
        $returnType = '\Drupal\tmgmt_contentapi\Swagger\Client\Model\CreateRequestUpdateTM';
    ...
    protected function jobsJobIdTmUpdatefilePutRequest($authorization, $job_id, $body)
    {
        ...
        $resourcePath = '/jobs/{jobId}/tmupdates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
