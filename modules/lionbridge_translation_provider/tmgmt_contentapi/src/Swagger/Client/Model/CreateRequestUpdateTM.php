...
/**
 * CreateRequestUpdateTM Class Doc Comment
 *
 * @category Class
 * @package  Drupal\tmgmt_contentapi\Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateRequestUpdateTM implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateRequestUpdateTM';
     ...
     * Sets file_id
     *
     * @param string $file_id ID of file containing updated content to use in this UpdateTM.
     *
     * @return $this
     */
    #[\ReturnTypeWillChange]
     ...
     *
     * @param string $source_native_language_code Source language code of the update in the content system.
     *
     * @return $this
     */
    #[\ReturnTypeWillChange]
     ...
     *
     * @param string $target_native_language_code Target language code of the update in the content system.
     *
     * @return $this
     */
    #[\ReturnTypeWillChange]
