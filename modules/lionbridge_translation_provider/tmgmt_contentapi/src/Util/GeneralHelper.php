...
class GeneralHelper {
  ...
  public static function getAllJobsByTranslator(TranslatorInterface $translator){
    ...
    //$trjobs = \Drupal::entityTypeManager()->getStorage('tmgmt_job')->loadByProperties(['translator' => $trname]);
    $trjobs = \Drupal::entityTypeManager()->getStorage('tmgmt_job')->loadByProperties(['translator' => $trname, 'state' => Job::STATE_ACTIVE]);
    return $trjobs;
  }
